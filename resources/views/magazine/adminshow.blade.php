...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div>
              ...
              <form action="{{route('magazine.store')}}" method="post" enctype="multipart/form-data" id="form" class="mb-5">
                @csrf
                  ...
                  <div class="mt-3">
                    ...
                    <input class="form-control mb-1" type="text" id="title" name="title" placeholder="Le titre de votre magazine" value="{{old('title',$magazine->title)}}">
                    <input class="form-control mb-1" type="text" id="image" name="image" placeholder="L'url d'une image de fond" value="{{old('image',$magazine->image)}}">
            ...
            <!--<div class="col-md-3">
                <img src="{{$magazine->image}}"  class="img-thumbnail" width="200px" height="250px" /> 
            ...
            <div class="">
                        <iframe src="{{asset('magazines/'.$magazine->path_name)}}" frameborder="0" class="img-thumbnail" width="100%" style="height: 550px;" ></iframe>
            </div>
