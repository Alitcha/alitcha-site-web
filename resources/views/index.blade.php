            ...
            <div class="carousel-caption">
              <div class="container ">
                <div class="row justify-content-start ">
                  <div class="col-lg-7">
                    <h1 class="display-5 mb-2 animated slideInDown">Une communauté de jeunes entreprenants & créatifs
                    </h1>
                    <h5 class="pb-3 animated mb-4 slideInDown" style="color:black;">Notre vocation est de travailler
                      sur des projets
                      innovants et futuristes tout en vous en apprenant le plus possible sur la science et ses
                      dérivées.</h5>
              ...
              <div class="container">
                <div class="row justify-content-start">
                  <div class="col-lg-7">
                    ...
                    <h5 class=" mb-5">
                      Allons à la rencontre des technologies futures pour améliorer des conditions de vie des
                      populations.
                    </h5>
                    <a href={{ url('/webmagazine') }} class="btn btn-primary rounded-pill py-sm-3 px-sm-5">
                      Magazine</a>
              ...
              <div class="container">
                <div class="row justify-content-start">
                  <div class="col-lg-7">
                    ...
                    <h5 class=" mb-5">
                      Le numérique envahit notre quotidien : œuvrons pour l’émergence d’une société numérique innovante,
    ...
    <div class="container-xxl mt-5 pb-5" style="margin-top:-7em;">
      <div class="container pb-5 px-lg-5 text-center">
        <div class="row g-4">
          ...
          <h6 class="mb-4 text-center" style="color:black;">Recherche, innovation, apprentissage et partage sont le
            quotidien des labmates de Alitcha.<br>
          ...
          <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="feature-item bg-light rounded text-center pt-4">
              ...
              <div class="bg-gradient rounded-bottom">
                <p class="mx-2 p-1 p-md-4 bg-white" style="color:black;">Composé d'amoureux de l'ingénierie innovante,
                  l'équipe technologique de
          ...
          <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
            <div class="feature-item bg-light rounded text-center pt-4">
              ...
              <div class="bg-gradient rounded-bottom">
                <p class="mx-2 p-1 p-md-4 bg-white" style="color:black;">Formé par des amateurs de la technologie
                  numérique, cette équipe met en
          ...
          <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
            <div class="feature-item bg-light rounded text-center pt-4">
              ...
              <div class="bg-gradient rounded-bottom">
                <p class=" mx-2 p-1 p-md-4 bg-white" style="color:black;">Conscient des exigences environnementales
                  liées à un développement
              ...
              <div class="rounded overflow-hidden">
                <div class="position-relative overflow-hidden">
                  ...
                  <div class="portfolio-overlay">
                    <a href="{{ route('article', $article->id) }}" class="btn btn-square btn-outline-light mx-2"
                      href="img/portfolio-1.jpg"><i class="ps-2 fa fa-eye"></i></a>
                ...
                <div class="bg-gradient">
                  <div class="bg-light p-1 p-md-4 mx-2">
                    <h3 class="text-primary fw-medium mb-2"><a
                        href="{{ route('article', $article->id) }}">{{ $article->title }}</a></h3>
                    <p class="mb-0" style="color:#000000 !important">{{ $article->subtitle }}</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container-xxl py-6">
      <div class="container">
        <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
          <div class="d-inline-block border rounded-pill text-primary px-4 mb-3" style="color:black;">Notre équipe
          </div>
          ...
          @foreach ($team as $member)
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="team-item">
                ...
                <img class="img-fluid rounded-circle w-100 mb-4" src="img/team/{{ $member->img_path }}"
                  alt="">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-12 col-12 text-center">
            ...
            <div class="position-relative w-100 mt-3">
              <input class="form-control border-0 rounded-pill w-100 ps-4 pe-5" id="newsletterForm" type="text"
                placeholder="Entrer votre mail" style="height: 48px;">
              <button type="button" class="btn shadow-none position-absolute top-0 end-0 mt-1 me-0"
                id="newsletterSubmit"><i class="fa fa-paper-plane fs-4" style="color:#F77B1E;"></i></button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <div class="d-flex pt-2">
              ...
              <a class="btn btn-square btn-outline-primary me-1"
                href="https://www.facebook.com/Alitcha-106586631967294" target="_blank" data-toggle="tooltip"
                data-placement="top" title="Facebook"><i class="fab fa-facebook-f fs-4 p-1"></i></a>
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p>Rejoignez notre newsletter pour recevoir des informations en temps réel sur Alitcha et notre Webmagazi
            </p>
