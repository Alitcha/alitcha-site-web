...
<head>
  ...
  <link rel="stylesheet"
    href="https://fonts.googleapis.com/css2?family=Barlow+Semi+Condensed:wght@300;400;500;600;700;800&family=Roboto:wght@300;400;500;700;900&display=swap">
      ...
      <div class="container mt-lg-5 pt-lg-5">
        <div class="row no-gutters justify-content-center bg-white">
          <div class="col-lg-8 blog-single">
            <nav aria-label="breadcrumb fs-2">
              <ol class="breadcrumb">
            ...
            <div class="blog-post mt-3">
              <div class="blog-content pb-2 ps-0">
                ...
                <div class="post-meta m-auto mt-3">
                  <span class="post-author"><a href="/search/article?author={{ $article->author->id }}"
                      title="{{ $article->author->firstname }}">{{ $article->author->firstname }}
                      {{ $article->author->lastname }}</a></span>
                  <span class="post-date published">{{ $article->created_at->diffForHumans() }}</span>
                </div>
                <div class="mt-3">
                ...
                <div class="blog-post-share-box d-flex flex-wrap justify-content-between align-items-center mt-5">
                  <div class="blog-post-share">
                    <div class="share-box">
                      ...
                      <ul class="list-unstyled share-box-social" style="min-width : 120px !important;">
                        <li> <a
                            href="https://www.facebook.com/sharer.php?u=http://127.0.0.1:8000/article/{{ $article->id }}"
                            target="_blank"><i class="fab fa-facebook-f"></i></a> </li>
                        <li> <a
                            href="https://twitter.com/intent/tweet?url=http://127.0.0.1:8000/article/{{ $article->id }}"
                            target="_blank"><i class="fab fa-twitter"></i></a> </li>
                        <li> <a
                            href="https://www.linkedin.com/shareArticle?url=http://127.0.0.1:8000/article/{{ $article->id }}&title="
                  ...
                  <form class="row" action="{{ route('addComment', $article->id) }}" method="post">
                    ...
                    <div class="col-lg-4 mb-3">
                      <input type="text" class="form-control" placeholder="Votre Nom" name="nom"
                        name="comment" style="border-radius : 5px !important;">
                    </div>
                    {{-- <div class="col-lg-4 mb-3">
                    ...
                    <div class="col-lg-12 mb-3">
                      <textarea class="form-control" rows="5" placeholder="Votre Commentaire" name="comment"
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="bg-white p-4">
              ...
              <div class="owl-carousel blog-arrow" data-nav-arrow="true" data-nav-dots="false" data-items="3"
                data-md-items="2" data-sm-items="1" data-xs-items="1" data-xx-items="1" data-space="15">
                    ...
                    <div class="d-flex flex-column w-100 ">
                      <div class="blog-post hentry index-post d-flex flex-column">
                        <div class="post-image-wrap ">
                          <a class="post-image-link" href="/article/<?php echo $articleSimilaire->id; ?>">
                            <img alt="" class="post-thumb lazy-yard w-100" src="<?php echo $articleSimilaire->image; ?>">
                          </a>
                          <span class="post-tag index-post-tag">
                            {{ $articleSimilaire->categorie->name }}
                          </span>
                        </div>
                        <div class="post-info col-8">
                          <h2 class="post-title">
                            <a href="/article/<?php echo $articleSimilaire->id; ?>">{{ $articleSimilaire->title }}</a>
                          </h2>
                          <div class="post-meta">
                            <span class="post-author"><a
                                href="/search/article?author={{ $articleSimilaire->author->id }}"
                                title="{{ $articleSimilaire->author->firstname }}">{{ $articleSimilaire->author->firstname }}</a></span>
                            <span class="post-date published">{{ $articleSimilaire->created_at }}</span>
                          </div>
                          <p class="post-snippet">{{ $articleSimilaire->subtitle }}</p>
                          <a class="read-more" href="/article/<?php echo $articleSimilaire->id; ?>">Lire plus</a>
                        </div>
                      </div>
                    </div>
                  @endif
